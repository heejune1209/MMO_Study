...
-- 각 번호 : PagePID
--									1025(Leverling)
--						1048(Dodsworth)				1024(Leverling)
--		1008(Buchana..)			    1016(Dodsworth..)				1017(Leverling..)
...
DBCC PAGE('Northwind', 1/*파일번호*/, 1017/*페이지번호*/, 3/*출력옵션*/);
DBCC PAGE('Northwind', 1/*파일번호*/, 1048/*페이지번호*/, 3/*출력옵션*/);
...
-- C가 알파뱃 순서로 더 빠르기 때문에 왼쪽으로 이동을 하게 되고(1048)
-- 마찬가지로 알파뱃을 비교를 한다.
-- 그렇게 다시 왼쪽으로 이동을 한 다음(1008) 여기서 Callahan의 정보를 찾을 수 있다.
